...
;bài 3: nhap vao ki tu tu ban phim, in ki tu da nhap ra
;bai 4: nhap vào 1 ki tu in thuong tu ban phim, chuyen thanh in hoa in ra
;bai 5: nhap vao chuoi ki tu bat ki, in chuoi ki tu da nhap
;bai 6:nhap mot chuoi bat kì, co ca in hoa và in thuong
.Model small
.stack 100h
.data
 tb1 db 'xin chao $'
